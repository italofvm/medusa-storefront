    ...
    <div class="items-center container relative h-full grid grid-cols-2">
      <div class="py-20 flex-1 pr-10">
        ...
        <p class="flex-1 text-zinc-600 text-base mb-10">
          Usando a nova coleção da Umbrella você fica pronto para qualquer
          tempestade.
        </p>
        <nuxt-link to="/colecoes">
          <Button size="lg"> Nova Coleção </Button>
        </nuxt-link>
      </div>
    </div>
    <div
      class="absolute w-full h-full top-0 left-0 grid grid-cols-2 pointer-events-none">
      <div class="col-start-2 w-full h-full overflow-hidden">
        <img
          src="../public/hero.png.png"
          class="w-full h-full object-center object-cover" />
      </div>
    </div>
  </section>
  <section class="container my-40">
    <h2 class="font-extrabold mb-4 text-3xl">Só no precinho 🔥</h2>
